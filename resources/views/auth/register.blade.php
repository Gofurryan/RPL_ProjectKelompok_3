...
<head>
    ...
    <!-- Judul tab diubah menjadi Daftar -->
    <title>Daftar - Inventaris Ibadah</title>
...
<!-- State awal: Default diset jadi 'true' agar langsung menggeser ke panel Daftar -->
<div x-data="{ isSignUp: true }"
